...
# Initialize the HuggingFaceLLM with a smaller GPT model that doesn't require GPU (e.g., distilgpt2)
llm = HuggingFaceLLM(
    model_name="distilgpt2",  # Use distilgpt2 for CPU-based model
    ...
    generate_kwargs={"temperature": 0.1, "do_sample": True}  # Reduce temperature to avoid repetition
)
